...
"""
Launch file for robot side teleoperation.
Starts serial bridge nodes to receive /cmd_vel commands from network
and forward them to ESP32 via serial port.
"""
...
def generate_launch_description():
    """Generate launch description for robot teleoperation receiver."""
    ...
    # Node-bridge between ROS and ESP32 through serial
    bridge_node = Node(
        package='serial_bridge_package',
